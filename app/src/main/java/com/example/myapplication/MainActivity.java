...
@Override
    ...
    private void initCarApi() {
       ...
       // mDiagnosticManager = (CarDiagnosticManager) mCarApi.getCarManager(android.car.Car.DIAGNOSTIC_SERVICE);
    }
